var guests = ["Mr Fahad", "Mozzam", "Azam"];
...
console.log("Dear friend " + guests[3] + ", this is the second invitation as we have now different list of people. Hope see you there.");
