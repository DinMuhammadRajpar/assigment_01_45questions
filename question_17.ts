let guests: string[] = ["Mohsin", "Ali", "Zain", "Mozzam", "Azam", "Rizwan"];
...
console.log("Sorry " + removed1_guest + " due to the unavailibility of the bigger table you are no longer invited.");
let removed2_guest = guests.pop();
console.log("Sorry " + removed2_guest + " due to the unavailibility of the bigger table you are no longer invited.");
let removed3_guest = guests.pop();
console.log("Sorry " + removed3_guest + " due to the unavailibility of the bigger table you are no longer invited.");
let removed4_guest = guests.pop();
console.log("Sorry " + removed4_guest + " due to the unavailibility of the bigger table you are no longer invited.");
